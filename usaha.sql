...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 06, 2022 at 05:24 PM
...
(3, 'christo', 'christo@gmail.com', '123', '08080808', 'Rumah', '2022-12-06 16:18:31', 'Member', NULL),
(4, 'Christoper Gilbert Samuel Nero', 'coba@gmail.com', '$2y$10$Mdkfx9pyt9UT5hjML0vu1OM/ZNcx4ZMZLk0HuBMZYoEXLpgp7luK.', '085243187590', 'Jln. Raya', '2022-12-06 16:20:32', 'Member', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `pb_barangkeluar`
--

CREATE TABLE `pb_barangkeluar` (
...
--
-- Dumping data for table `pb_barangkeluar`
--

INSERT INTO `pb_barangkeluar` (`idkeluar`, `idbarang`, `tanggal`, `penerima`, `qty`) VALUES
(2, 1, '2022-12-06 15:32:02', 'Pembeli', 100);

-- --------------------------------------------------------

--
-- Table structure for table `pb_barangmasuk`
--

CREATE TABLE `pb_barangmasuk` (
...
--
-- Dumping data for table `pb_barangmasuk`
--

INSERT INTO `pb_barangmasuk` (`idmasuk`, `idbarang`, `tanggal`, `keterangan`, `qty`) VALUES
(2, 1, '2022-12-06 15:32:12', 'Lia', 200);
...
INSERT INTO `pb_stock` (`idbarang`, `namabarang`, `deskripsi`, `stock`) VALUES
(1, 'iPhone 13 Pro', 'Smartphone', 300);
...
--
-- Indexes for table `pb_barangkeluar`
--
ALTER TABLE `pb_barangkeluar`
  ADD PRIMARY KEY (`idkeluar`);

--
-- Indexes for table `pb_barangmasuk`
--
ALTER TABLE `pb_barangmasuk`
...
--
-- AUTO_INCREMENT for table `pb_barangkeluar`
--
ALTER TABLE `pb_barangkeluar`
  MODIFY `idkeluar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `pb_barangmasuk`
--
ALTER TABLE `pb_barangmasuk`
