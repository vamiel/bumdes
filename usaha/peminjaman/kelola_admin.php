                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        $ambilsemuadataadmin = mysqli_query($conn, "SELECT * FROM pb_login");
                                        $i = 1;
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $em; ?></td>
                                                <td>
                                                    <button type="button" class="btn btn-warning mt-2" data-toggle="modal" data-target="#edit<?= $iduser; ?>">
                                                        Edit
                                                    </button>
                                                    <button type="button" class="btn btn-danger mt-2" data-toggle="modal" data-target="#delete<?= $iduser; ?>">
                                                        Delete
                                                    </button>
                                                </td>
                                            </tr>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <button type="submit" class="btn btn-primary" name="updatedataadmin">Submit</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <br>
                                                                <br>
                                                                <button type="submit" class="btn btn-danger" name="hapusdataadmin">Hapus</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
